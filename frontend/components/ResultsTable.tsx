...
// Custom header component for multiline headers
const MultilineHeader = ({ displayName }: { displayName: string }) => {
...
export function ResultsTable({ results, isLoading }: ResultsTableProps) {
  ...
  const columnDefs: ColDef[] = useMemo(() => [
    ...
    {
      headerName: "True Density|with error correction",
      field: "error_density",
      flex: 1,
      minWidth: 170,
      filter: "agNumberColumnFilter",
  ...
  ], [visibleColumns, handleImageClick]);
  ...
  }, [gridApi, results, visibleColumns]);
...
//   const columnDefs: ColDef[] = useMemo(() => [
//   {
//   headerName: "Compounds and SMILES",
//   field: "compound",
//   flex: 1,
//   minWidth: 220,
//   filter: "agTextColumnFilter",
//   floatingFilter: true,
//   tooltipField: "compound",
//   hide: !visibleColumns.compound || !visibleColumns.smiles,
...
//           title={params.data.compound}
//         >
//           {params.data.compound}
//         </span>
//         {/* SMILES */}
//         <span
//           className="text-xs font-mono text-gray-500 truncate"
//           title={params.data.smiles}
//         >
//           {params.data.smiles}
//         </span>
//       </div>
